...
class SinglePlatformAdminMigrationTests(unittest.TestCase):
    def test_migration_normalizes_roles_and_pins_admin_email(self) -> None:
        ...
        self.assertIn("role = 'admin' AND email_normalized = '2963613812@qq.com'", source)
        self.assertIn("role = 'user' AND email_normalized IS DISTINCT FROM '2963613812@qq.com'", source)
