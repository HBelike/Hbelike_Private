...
- 核心优势选材：DeepSeek 在匹配 JD 前先完整扫描学历、工作经验、奖项/荣誉、个人项目和岗位相关成果；只从存在简历证据的类别中选择 2–4 项，优先覆盖学历、工作经验与个人项目，避免用单一项目的技术细节占满全文。Prompt 中的 Few-shot 只示范信息密度和组织方式，示例事实禁止迁移，缺失类别必须省略。
