...
11. **当前生产版本**：2026-08-22 已部署提交 `3958993`，PostgreSQL 迁移至 `20260821_16`；求职资料工作区、BOSS 职位库导入、简历助手、评测中心、主题系统、Skill Agent 与音视频关闭策略均已进入生产。公网健康接口返回 200，API/Web/PostgreSQL/Scheduler 均正常。
