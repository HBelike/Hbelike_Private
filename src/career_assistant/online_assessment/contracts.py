...
class CapturedProblemInput(BaseModel):
    ...
    capture_contract_version: int = Field(default=2, ge=1, le=2)
    adapter_key: str = Field(default="generic", max_length=80)
    adapter_version: str = Field(default="2", max_length=40)
    field_sources: dict[str, str] = Field(default_factory=dict)
    question_type_hint: str = Field(default="", max_length=80)
    choice_candidates: list[str] = Field(default_factory=list, max_length=20)
...
class AssessmentProblem(BaseModel):
    ...
    starter_code: str = Field(default="", max_length=80_000)
    problem_type: ProblemKind = ProblemKind.ALGORITHM
...
class AssessmentSolution(BaseModel):
    ...
    answer_markdown: str = Field(default="", max_length=40_000)
